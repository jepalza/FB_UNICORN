...
Type uc_x86_mmr 
    As uint16_t selector   /' not used by GDTR and IDTR '/
    As uint64_t base_       /' handle 32 or 64 bit CPUs '/
    As uint32_t limit 
    As uint32_t flags    /' not used by GDTR and IDTR '/
End Type 
...
Type uc_x86_msr 
    As uint32_t rid    ' MSR id
    As uint64_t value  ' MSR value
 End Type 
